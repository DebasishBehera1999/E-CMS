...
import { View, TextInput, Alert, Text, ScrollView, StyleSheet, Linking, TouchableOpacity } from 'react-native';
...
// Sequence number storage (can be replaced with a more persistent solution)
let sequenceNumbers = {};
    ...
    >
      ...
      {({ handleChange, handleBlur, handleSubmit, setFieldValue, values, errors, touched }) => (
        <ScrollView contentContainerStyle={styles.container}>
          <Text style={styles.header}> PUBLIC COMPLAINT FORM </Text>
